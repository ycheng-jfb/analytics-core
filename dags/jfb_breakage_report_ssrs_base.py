...
dag = DAG(
    "jfb_breakage_report_ssrs_base",  # DAG任务名   建议python 脚本名字，DAG任务名，sql脚本名三者统一
...
run_sql_file = SnowflakeOperator(
    task_id="jfb_breakage_report_ssrs_base",
    sql="sql/jfb_breakage_report_ssrs_base.sql",  # 执行脚本的相对路径
