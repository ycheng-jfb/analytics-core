...
class CallMinerBulkContactsHook(BaseHook):
    def __init__(
        self,
        ...
        self.contacts_job_id = self.extras.get("contacts_job_id")
        self.categories_job_id = self.extras.get("categories_job_id")
        self.categories_components_job_id = self.extras.get("categories_components_job_id")
        self.scores_job_id = self.extras.get("scores_job_id")
        self.score_indicators_job_id = self.extras.get("score_indicators_job_id")
    ...
    def make_request(
        self, method, endpoint, headers=None, params=None, json=None, data=None, stream=None
    ):
