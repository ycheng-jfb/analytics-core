SET is_empty = (SELECT NOT EXISTS(SELECT 1 FROM reporting_prod.credit.loyalty_points));
...
DELETE
FROM reporting_prod.credit.loyalty_points
...
INSERT INTO reporting_prod.credit.loyalty_points
(store_id,
...
FROM lake_consolidated_view.ultra_merchant.membership_reward_transaction mrt
    ...
    AND mrt.datetime_added BETWEEN c.effective_start_datetime AND c.effective_end_datetime
         ...
         LEFT JOIN reporting_prod.credit.loyalty_points lp
...
UPDATE reporting_prod.credit.loyalty_points
