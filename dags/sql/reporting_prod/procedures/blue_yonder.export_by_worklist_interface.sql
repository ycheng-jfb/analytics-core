use reporting_prod;
truncate table reporting_prod.blue_yonder.export_by_worklist_interface_stg;

insert into reporting_prod.blue_yonder.export_by_worklist_interface_stg(
	OPERATION_CODE,
	DEFAULT_WAREHOUSE,
	QUANTITY_PER_PACK,
	PACK_SKU,
...
update reporting_prod.blue_yonder.export_by_WORKLIST_interface_stg
set
