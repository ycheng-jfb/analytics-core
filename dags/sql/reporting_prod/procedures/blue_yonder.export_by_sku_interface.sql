...
truncate table reporting_prod.blue_yonder.export_by_sku_interface_stg;

insert into reporting_prod.blue_yonder.export_by_sku_interface_stg(
ITEM,
LOC,
REPLENTYPE
)
...
update reporting_prod.blue_yonder.export_by_SKU_interface_stg
set
