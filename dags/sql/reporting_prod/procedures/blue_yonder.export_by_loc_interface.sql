use reporting_prod;
truncate table reporting_prod.blue_yonder.export_by_loc_interface_stg;

insert into reporting_prod.blue_yonder.export_by_loc_interface_stg(
	LOCATION,
	DESCR,
	TYPE,
	TOTAL_COMPANY,
...
update reporting_prod.blue_yonder.export_by_Loc_interface_stg
set
