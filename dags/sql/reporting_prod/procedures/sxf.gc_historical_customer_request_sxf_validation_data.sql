...
SET max_snapshot_datetime = (SELECT MAX(snapshot_datetime) FROM sxf.gc_historical_customer_request_sxf_snapshot);
...
SET thisweek_snapshot = (
    ...
    FROM sxf.gc_historical_customer_request_sxf_snapshot
...
SET table_name = 'reporting_prod.sxf.gc_historical_customer_request_sxf_snapshot';
...
SELECT DATE_TRUNC('MONTH', payment_date) AS month_date,
    ...
    "Product Order Variable GMS Cost Amount" + "Billing Variable GMS Cost Amount" + "Product Order Payment Processing Cost Amount"
        ...
        + "Selling Expenses" + "GFC Fixed" + "GMS Fixed"
        AS "Total Expenses",
...
DELETE FROM sxf.gc_historical_customer_request_sxf_validation_data
WHERE snapshot_detail = $snapshot_detail;

INSERT INTO sxf.gc_historical_customer_request_sxf_validation_data (
    date,
    store_region,
    brand,
    customer_segment,
