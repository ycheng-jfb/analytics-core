...
truncate table reporting_prod.blue_yonder.export_by_dfu_interface_stg;

insert into reporting_prod.blue_yonder.export_by_dfu_interface_stg
(
DMDUNIT,
DMDGROUP,
LOC,
...
update reporting_prod.blue_yonder.export_by_DFU_interface_stg
set
