...
create or replace temporary table _raw_impressions as (
    ...
    from lake.segment_gfb.javascript_shoedazzle_PRODUCT_LIST_VIEWED so
...
'browse_cart_offer%', 'myaccount_favorites', 'browse:sale%', 'skip_request', 'browse:modal:fbw', 'pdp_ymal')
