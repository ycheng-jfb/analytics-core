...
TRUNCATE TABLE REPORTING_PROD.sxf.custom_segment_waterfall_growth;

INSERT INTO REPORTING_PROD.sxf.custom_segment_waterfall_growth
(
...
JOIN REPORTING_PROD.sxf.view_custom_segment_growth cs ON cs.customer_id = cwc.customer_id AND cs.vip_cohort = cwc.vip_cohort_month_date
GROUP BY
         vip_cohort_month_date,
         membership_type,
         month_date,
