use reporting_prod;
truncate table reporting_prod.blue_yonder.export_by_INVENTORY_interface_stg;

insert into reporting_prod.blue_yonder.export_by_INVENTORY_interface_stg(
	ITEM,
	LOC,
	AVAILDATE,
	UNITS,
...
update reporting_prod.blue_yonder.export_by_INVENTORY_interface_stg
set
