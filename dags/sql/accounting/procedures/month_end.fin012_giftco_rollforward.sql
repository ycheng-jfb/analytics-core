...
--     IFF(gc.MERCHANT_ID = 1002, 'FLGC', 'JFGC')
       CASE
            WHEN ds.store_brand IN ('Fabletics', 'Yitty') THEN 'FLGC'
            WHEN ds.store_brand = 'Savage X' THEN 'SXGC'
            ELSE 'JFGC'
       END                                                                               AS legal_entity,
...
CREATE OR REPLACE TRANSIENT TABLE month_end.fin012_giftco_rollforward
...
ALTER TABLE month_end.fin012_giftco_rollforward
...
INSERT INTO month_end.fin012_giftco_rollforward_snapshot
...
FROM month_end.fin012_giftco_rollforward;

DELETE
FROM month_end.fin012_giftco_rollforward_snapshot
