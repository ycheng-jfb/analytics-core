...
DELETE FROM breakage.jfb_token_breakage_report
where recognition_booking_month = $month_thru;

INSERT INTO breakage.jfb_token_breakage_report
...
INSERT INTO breakage.jfb_token_breakage_report_snapshot
SELECT business_unit,
       brand,
       region,
       country,
...
DELETE
FROM breakage.jfb_token_breakage_report_snapshot
