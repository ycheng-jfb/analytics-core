CREATE OR REPLACE TRANSIENT TABLE month_end.token_purchases_tax AS
SELECT st.store_brand,
       st.store_country,
       month_end.udf_correct_state_country(a.state, a.country_code, 'country')                  AS shipping_country,
       month_end.udf_correct_state_country(a.state, a.country_code, 'state')                    AS shipping_state,
       zcs.county,
...
ALTER TABLE month_end.token_purchases_tax
    SET DATA_RETENTION_TIME_IN_DAYS = 0;

-- snapshot
INSERT INTO month_end.token_purchases_tax_snapshot
SELECT store_brand,
       store_country,
       shipping_country,
       shipping_state,
...
FROM month_end.token_purchases_tax;

DELETE
FROM month_end.token_purchases_tax_snapshot
