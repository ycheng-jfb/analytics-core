...
CREATE OR REPLACE TEMPORARY TABLE _append_sx_us AS
...
DELETE FROM breakage.savagex_us_breakage_report
where activity_month = $month_thru;


INSERT INTO breakage.savagex_us_breakage_report
SELECT brand,
       region,
       country,
       original_credit_tender,
...
INSERT INTO breakage.savagex_us_breakage_report_snapshot
SELECT brand,
       region,
       country,
       original_credit_tender,
...
DELETE
FROM breakage.savagex_us_breakage_report_snapshot
