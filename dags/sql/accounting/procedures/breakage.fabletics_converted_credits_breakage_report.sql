...
MERGE INTO breakage.fabletics_converted_credits_breakage_report t
...
INSERT INTO breakage.fabletics_converted_credits_breakage_report_snapshot
SELECT brand,
       region,
       country,
       currency,
...
DELETE
FROM breakage.fabletics_converted_credits_breakage_report_snapshot
