CREATE OR REPLACE TABLE month_end.emp_token_outstanding
    (
     brand VARCHAR(155),
...
INSERT INTO month_end.emp_token_outstanding_snapshot
SELECT brand,
       store_region,
       store_country,
       current_membership_state,
       ...
       outstanding_amount,
       datetime_updated
FROM month_end.emp_token_outstanding;

DELETE
FROM month_end.emp_token_outstanding_snapshot
