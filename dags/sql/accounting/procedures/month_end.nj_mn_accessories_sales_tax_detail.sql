...
CREATE OR REPLACE TRANSIENT TABLE month_end.nj_mn_accessories_sales_tax_detail AS
-- Online Sales
SELECT month_end.udf_correct_state_country(a.state, a.country_code, 'country') AS country,
       'SALES'                                                                                  AS segment,
       ...
       ol.product_id,
       NULL                                                                                     AS refund_id,
       month_end.udf_correct_state_country(a.state, a.country_code, 'state')   AS state,
       zcs.county,
...
ALTER TABLE month_end.nj_mn_accessories_sales_tax_detail
    SET DATA_RETENTION_TIME_IN_DAYS = 0;

-- snapshot
INSERT INTO month_end.nj_mn_accessories_sales_tax_detail_snapshot
SELECT country,
       segment,
       business_unit,
       store_type,
...
FROM month_end.nj_mn_accessories_sales_tax_detail;

DELETE
FROM month_end.nj_mn_accessories_sales_tax_detail_snapshot
