use reporting_dev;
truncate table reporting_dev.blue_yonder.export_by_INVENTORY_TRANSACTION_interface_stg;

insert into reporting_dev.blue_yonder.export_by_INVENTORY_TRANSACTION_interface_stg(
	ITEM,
	LOC,
	STARTDATE,
	TRANSACTIONCODE,
...
update reporting_dev.blue_yonder.export_by_INVENTORY_TRANSACTION_interface_stg
set
