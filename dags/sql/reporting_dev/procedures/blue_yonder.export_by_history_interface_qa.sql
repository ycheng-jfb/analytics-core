...
truncate table reporting_dev.blue_yonder.export_by_history_interface_stg;

insert into reporting_dev.blue_yonder.export_by_history_interface_stg
(
SKU,
CC,
DMDGROUP,
...
and cc not in (
    ...
    (
        select item
        from reporting_dev.blue_yonder.export_by_item_interface_stg -- today's feed
        where item not in (
                select item
                from reporting_dev.blue_yonder.export_by_item_interface -- snapshot table
...
delete from reporting_dev.blue_yonder.export_by_history_interface_stg
where SKU is null
or CC is null
or LOC is null;

update reporting_dev.blue_yonder.export_by_HISTORY_interface_stg
set
