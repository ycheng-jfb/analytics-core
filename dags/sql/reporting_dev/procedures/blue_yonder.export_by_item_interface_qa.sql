...
TRUNCATE TABLE reporting_dev.blue_yonder.export_by_item_interface_stg;

insert into reporting_dev.blue_yonder.export_by_item_interface_stg
(
ITEM,
DESCR,
TOTAL_COMPANY,
...
select ITEM,
    ...
    RETAIL_PRICE,
    MSP_PRICE
FROM reporting_dev.blue_yonder.export_by_item_interface
...
update reporting_dev.blue_yonder.export_by_ITEM_interface_stg
set
