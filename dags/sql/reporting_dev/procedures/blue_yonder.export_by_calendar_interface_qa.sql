use reporting_dev;
TRUNCATE TABLE reporting_dev.blue_yonder.export_by_calendar_interface_stg;

INSERT INTO reporting_dev.blue_yonder.export_by_calendar_interface_stg
(
DAY,
WEEK,
MONTH,
...
update reporting_dev.blue_yonder.export_by_CALENDAR_interface_stg
set
