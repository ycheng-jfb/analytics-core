use reporting_dev;
TRUNCATE TABLE reporting_dev.blue_yonder.export_by_transportload_interface_stg;

INSERT INTO reporting_dev.blue_yonder.export_by_transportload_interface_stg
(
LOADID,
ARRIVDATE,
SHIPDATE,
...
update reporting_dev.blue_yonder.export_by_transportLoad_interface_stg
set
