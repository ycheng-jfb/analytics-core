use reporting_dev;
truncate table reporting_dev.blue_yonder.export_by_network_interface_stg;

insert into reporting_dev.blue_yonder.export_by_network_interface_stg
(
	SOURCE,
	DEST,
	TRANSMODE,
...
update reporting_dev.blue_yonder.export_by_NETWORK_interface_stg
set
