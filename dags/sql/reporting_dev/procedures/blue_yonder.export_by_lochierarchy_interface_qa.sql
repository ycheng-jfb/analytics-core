...
REGION,
'REGION'
from reporting_dev.blue_yonder.export_by_loc_interface_stg;
...
MERGE INTO reporting_dev.blue_yonder.export_by_lochierarchy_interface_stg t
USING _final s
...
DELETE FROM reporting_dev.blue_yonder.export_by_lochierarchy_interface_stg
