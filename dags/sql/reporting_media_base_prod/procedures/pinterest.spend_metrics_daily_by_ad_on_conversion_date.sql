set high_watermark_datetime = (select max(meta_update_datetime) as datetime from lake_view.pinterest.spend_ad1_on_conversion_date);

create or replace transient table reporting_media_base_prod.pinterest.spend_metrics_daily_by_ad_on_conversion_date as
select
        account_id,
        campaign_id,
        adgroup_id,
    ...
    from (
        ...
        from lake_view.pinterest.spend_ad1_on_conversion_date a1
        full join (select distinct
                    ...
                    from lake_view.pinterest.spend_ad7_on_conversion_date
        ...
        full join (select distinct
                        ...
                        sum(total_view_checkout) as total_view_checkout,
                        sum(total_engagement_checkout) as total_engagement_checkout
                    from lake_view.pinterest.spend_ad30_on_conversion_date
