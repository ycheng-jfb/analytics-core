CREATE OR REPLACE VIEW IF NOT EXISTS LAKE_VIEW.FACEBOOK.ACTIONS_BY_COUNTRY_7_D (
	account_id,
	account_name,
	ad_id,
	country,
...
FROM lake_fivetran.med_facebook_ads_2hr_v1.actions_by_country_7_d_actions b
FULL JOIN lake_fivetran.med_facebook_ads_2hr_v1.actions_by_country_7_d_conversions c
    ON b.ad_id=c.ad_id AND b.date=c.date AND b._fivetran_id=c._fivetran_id AND b.action_type=c.action_type
FULL JOIN lake_fivetran.med_facebook_ads_2hr_v1.actions_by_country_7_d_conversion_values d
    ON b.ad_id=d.ad_id AND b.date=d.date AND b._fivetran_id=d._fivetran_id AND b.action_type=d.action_type
FULL JOIN lake_fivetran.med_facebook_ads_2hr_v1.actions_by_country_7_d_action_values e
    ON b.ad_id=e.ad_id AND b.date=e.date AND b._fivetran_id=e._fivetran_id AND b.action_type=e.action_type
FULL JOIN lake_fivetran.med_facebook_ads_2hr_v1.actions_by_country_7_d_video_play_actions f
    ON b.ad_id=f.ad_id AND b.date=f.date AND b._fivetran_id=f._fivetran_id AND b.action_type=f.action_type
FULL JOIN lake_fivetran.med_facebook_ads_2hr_v1.actions_by_country_7_d a
