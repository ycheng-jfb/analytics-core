create or replace view LAKE_VIEW.MICROSOFT_ADS.ACCOUNT_PERFORMANCE_HOURLY_REPORT as
select
ACCOUNT_ID
,AD_DISTRIBUTION
,BID_MATCH_TYPE
...
from LAKE_FIVETRAN.MED_MICROSOFT_ADS_V1.ACCOUNT_PERFORMANCE_HOURLY_REPORT;
