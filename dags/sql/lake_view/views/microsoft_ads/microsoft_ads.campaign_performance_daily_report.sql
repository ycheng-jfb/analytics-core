create or replace view LAKE_VIEW.MICROSOFT_ADS.CAMPAIGN_PERFORMANCE_DAILY_REPORT as
select
_FIVETRAN_ID
,ACCOUNT_ID
,CAMPAIGN_ID
...
from LAKE_FIVETRAN.MED_MICROSOFT_ADS_V1.CAMPAIGN_PERFORMANCE_DAILY_REPORT;
