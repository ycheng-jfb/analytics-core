CREATE OR REPLACE VIEW lake_view.sharepoint.tenured_budget_and_forecast_sxf_by_region (
    DATE,
    TYPE,
    REGION,
    TENURE,
...
FROM lake_fivetran.savagex_inbound_sharepoint_v1.region_budget_forecast_data_sheet_1;
