...
CREATE OR REPLACE TRANSIENT TABLE audit.order_2023_jf AS
...
CREATE OR REPLACE TRANSIENT TABLE audit.membership_store_credit_2023_jf AS
...
CREATE OR REPLACE TRANSIENT TABLE audit.membership_credit_2023_jf AS
...
CREATE OR REPLACE TRANSIENT TABLE audit.issued_orders_2023_jf AS
...
CREATE OR REPLACE TRANSIENT TABLE audit.address_2023_jf as
...
WHERE a.address_id
		...
		FROM eybreakageaudit.audit.order_2023_jf)
	OR a.address_id
