...
CREATE TABLE analytics_base.customer_lifetime_value_monthly_agg_eu (
    month_date DATE,
...
GRANT OWNERSHIP ON TABLE analytics_base.customer_lifetime_value_monthly_agg_eu TO ROLE __EDW_ANALYTICS_BASE_RWC COPY CURRENT GRANTS;
