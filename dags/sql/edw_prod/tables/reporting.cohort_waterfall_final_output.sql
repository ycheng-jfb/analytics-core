CREATE OR REPLACE TABLE reporting.cohort_waterfall_final_output (
    vip_cohort_month_date DATE,
    membership_type VARCHAR(100),
    gender VARCHAR(20),
    month_date DATE,
    member_tenure_type VARCHAR(50),
    ...
    nonactivating_product_order_subtotal_amount NUMBER(38,4),
    ...
    skip_and_purchase_count NUMBER(38,0),
    billing_and_purchase_count NUMBER(38,0),
    ...
    billed_cash_credit_expired_equivalent_count NUMBER(38,0),
