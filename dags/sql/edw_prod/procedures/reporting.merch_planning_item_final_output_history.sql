/* THIS CODE IS NOT TIED TO ANY DAG. IT IS TO BE RAN MANUALLY BY GLOBAL APPS ON THE FIRST BUSINESS DAY OF THE YEAR */

SET (meta_create_datetime, meta_update_datetime) = (
...
/*
Incremental Logic:
    last_update_datetime: Maximum meta_update_datetime from merch_planning_item_final_output_history. 1900-01-01 if null
...
SET last_update_datetime = (
    ...
    FROM reporting.merch_planning_item_final_output_history
);
...
DELETE FROM reporting.merch_planning_item_final_output_history ifo
USING (
    SELECT source,
...
INSERT INTO reporting.merch_planning_item_final_output_history(
    date,
    period,
    date_type,
    store_id,
...
WHERE YEAR(p.start_date) <= (YEAR(localtimestamp()) -1)     -- HISTORICAL DATA FOR HISTORICAL M&P DASHBOARD
