CREATE OR REPLACE VIEW data_model_sxf.fact_chargeback
(
    order_id,
    customer_id,
    activation_key,
...
SELECT
    stg.udf_unconcat_brand(fc.order_id) AS order_id,
    stg.udf_unconcat_brand(fc.customer_id) AS customer_id,
    fc.activation_key,
...
FROM stg.fact_chargeback AS fc
...
WHERE NOT fc.is_deleted
    ...
    AND substring(fc.order_id, -2) = '30';
