CREATE OR REPLACE VIEW data_model_sxf.dim_customer
        (
         customer_id,
...
AS
SELECT stg.udf_unconcat_brand(c.customer_id)                                                        AS customer_id,
       ...
       stg.udf_unconcat_brand(c.default_address_id)                                                 AS default_address_id,
       c.default_address1,
       c.default_address2,
       c.default_city,
       ...
       edw_prod.stg.udf_unconcat_brand(c.first_mobile_app_session_id),
       c.first_mobile_app_order_local_datetime,
       edw_prod.stg.udf_unconcat_brand(c.first_mobile_app_order_id),
       c.mobile_app_cohort_month_date,
       CASE
           WHEN c.mobile_app_cohort_os ILIKE 'Mac%%' OR c.mobile_app_cohort_os ILIKE 'iOS'
               THEN 'Apple'
       ...
       c.membership_price,
       edw_prod.stg.udf_unconcat_brand(c.membership_plan_id),
...
WHERE ds.store_brand NOT IN ('Legacy')
  ...
  AND (SUBSTRING(c.customer_id, -2) = '30' OR c.customer_id = -1);
