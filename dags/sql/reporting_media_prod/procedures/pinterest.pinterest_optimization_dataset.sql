...
create or replace transient table reporting_media_prod.pinterest.pinterest_optimization_dataset as
select
        pin.*,
...
from reporting_media_base_prod.pinterest.spend_metrics_daily_by_ad pix
