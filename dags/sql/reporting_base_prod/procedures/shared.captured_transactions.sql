...
CREATE OR REPLACE TRANSIENT TABLE reporting_base_prod.shared.captured_transactions AS
...
ALTER TABLE reporting_base_prod.shared.captured_transactions SET DATA_RETENTION_TIME_IN_DAYS = 0;

INSERT INTO reporting_base_prod.shared.captured_transactions_snapshot
SELECT region,
       order_id,
       business_unit,
       retail_location,
...
FROM reporting_base_prod.shared.captured_transactions;
