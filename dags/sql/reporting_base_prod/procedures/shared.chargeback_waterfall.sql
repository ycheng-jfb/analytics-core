...
CREATE OR REPLACE TRANSIENT TABLE reporting_base_prod.shared.chargeback_waterfall_detail AS
SELECT CASE
...
ALTER TABLE reporting_base_prod.shared.chargeback_waterfall_detail SET DATA_RETENTION_TIME_IN_DAYS = 0;

--snap shot
INSERT INTO reporting_base_prod.shared.chargeback_waterfall_detail_snapshot
SELECT store,
...
FROM reporting_base_prod.shared.chargeback_waterfall_detail;

DELETE
FROM reporting_base_prod.shared.chargeback_waterfall_detail_snapshot
