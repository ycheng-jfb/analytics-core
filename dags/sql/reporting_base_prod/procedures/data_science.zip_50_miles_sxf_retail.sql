CREATE TABLE IF NOT EXISTS reporting_base_prod.data_science.zip_50_miles_sxf_retail
(
...
FROM lake_sxf_view.ultra_merchant.zip_city_state;
...
TRUNCATE TABLE REPORTING_BASE_PROD.DATA_SCIENCE.zip_50_miles_sxf_retail;
INSERT INTO REPORTING_BASE_PROD.DATA_SCIENCE.zip_50_miles_sxf_retail
SELECT DISTINCT
	zc.customer_state
	,zc.customer_zip
