...
CREATE OR REPLACE TRANSIENT TABLE reporting_base_prod.shared.na_sales_tax_detail AS
SELECT reporting_base_prod.shared.udf_correct_state_country(state, country, 'country') AS country,
       segment,
       business_unit,
       store_type,
       retail_location,
       ...
       credit_type,
       refund_id,
       reporting_base_prod.shared.udf_correct_state_country(state, country, 'state')   AS state,
       county,
       city,
       refund_type,
       transaction_type,
...
ALTER TABLE reporting_base_prod.shared.na_sales_tax_detail
    SET DATA_RETENTION_TIME_IN_DAYS = 0;

UPDATE reporting_base_prod.shared.na_sales_tax_detail
SET state  = 'IN',
...
DELETE
FROM reporting_base_prod.shared.na_sales_tax_detail
WHERE activity_month < '2015-01-01';

-- snapshot
INSERT INTO reporting_base_prod.shared.na_sales_tax_detail_snapshot
SELECT country,
       segment,
       business_unit,
       store_type,
...
DELETE
FROM reporting_base_prod.shared.na_sales_tax_detail_snapshot
