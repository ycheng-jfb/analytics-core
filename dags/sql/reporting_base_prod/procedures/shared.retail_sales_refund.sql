CREATE OR REPLACE TRANSIENT TABLE reporting_base_prod.shared.retail_sales_and_refund_detail AS
...
ALTER TABLE reporting_base_prod.shared.retail_sales_and_refund_detail SET DATA_RETENTION_TIME_IN_DAYS = 0;


INSERT INTO reporting_base_prod.shared.retail_sales_and_refund_detail_snapshot
...
FROM reporting_base_prod.shared.retail_sales_and_refund_detail;

DELETE
FROM reporting_base_prod.shared.retail_sales_and_refund_detail_snapshot
