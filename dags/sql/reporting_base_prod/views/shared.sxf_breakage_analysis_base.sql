CREATE
OR REPLACE VIEW reporting_base_prod.shared.sxf_breakage_analysis_base AS
...
FROM reporting_base_prod.shared.savagex_us_breakage_report
...
FROM shared.savagex_us_breakage_report b
...
SELECT concat(brand, ' ', country)                                                                 business_unit,
       ...
       concat('SX', country, '-', 'F')                                                             display_store,
       concat('SX', country, '-', original_credit_type)                                            store_credit_type
FROM shared.savagex_us_breakage_report
...
from shared.jfb_sxf_membership_credit_breakage_report
