...
from include.airflow.operators.facebook_export import SegmentFacebookConversionsExportOperator
...
Config = namedtuple(
    'Config', ['store', 'country', 'store_in_schema', 'store_in_table', 'pixel_id', 'region']
)
items = [
    ...
    Config('SX', ["'UK'", "'EU'", "'FR'", "'ES'", "'DE'"], 'SXF', 'SXF', '1653034964810714', 'EU'),
]
