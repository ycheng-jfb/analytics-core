...
dag = DAG(
    'jfb_converted_breakage_report',   # DAG任务名   建议python 脚本名字，DAG任务名，sql脚本名三者统一
...
run_sql_file = SnowflakeOperator(
    task_id='jfb_converted_breakage_report',
    sql='sql/jfb_converted_breakage_report.sql',  # 执行脚本的相对路径
