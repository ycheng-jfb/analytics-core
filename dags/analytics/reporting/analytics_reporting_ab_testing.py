...
with dag:
    ...
    check_s20_session_ab_test_vip_ltv = BranchPythonOperator(
        ...
        task_id="check_session_ab_test_vip_ltv_execution_time",
    )
    ...
    chain_tasks(
        [s12_ab_test_final, s7_session_ab_test_metadata], s13_ab_test_metadata_final
    )
    chain_tasks(
        s19_session_ab_test_orders_psource, s11_session_order_ab_test_detail_optimized
    )
    chain_tasks(
        s15_psource_promo_revenue_ab_test_final,
    ...
    chain_tasks(
        s15_psource_promo_revenue_ab_test_final, trigger_data_science_image_testing
    )
