...
with (dag):
    ...
    finance_sales_ops_stg >> daily_cash_base_calc >> daily_cash_final_output >> gfb059_finance_daily_sales
    ...
    finance_sales_ops_stg >> customer_lifetime_value_monthly >> vip_tenure_final_output
