...
from include.airflow.operators.asknicely_get_responses import AsknicelyResponsesToS3Operator
...
process_start_date = "{{macros.tfgdt.to_pst(macros.datetime.now()).date().add(days=-2)}}"
...
column_list = [
    ...
    Column('asknicely_responses_data', 'VARCHAR', source_name='asknicely_responses_data'),
