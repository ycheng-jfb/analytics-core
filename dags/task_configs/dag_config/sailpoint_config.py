...
config_list = [
    Config(
        ...
        column_list=[
            ...
            Column(
                "attributes_password_policies",
                "VARCHAR",
                source_name="attributes_passwordPolicies",
            ),
            ...
            Column(
                "attributes_risk_level", "VARCHAR", source_name="attributes_riskLevel"
            ),
            Column(
            ...
            Column(
                "attributes_proxy_addresses",
                "VARIANT",
                source_name="attributes_proxyAddresses",
            ),
            Column(
                "attributes_site_collections",
                "VARIANT",
                source_name="attributes_SiteCollections",
            ),
            Column("attributes_domain", "VARCHAR", source_name="attributes_domain"),
            Column("attributes_name", "VARCHAR", source_name="attributes_Name"),
            Column(
                "attributes_risk_state", "VARCHAR", source_name="attributes_riskState"
            ),
            Column(
            ...
            Column(
                "attributes_login_name", "VARCHAR", source_name="attributes_LoginName"
            ),
            Column(
                "attributes_risk_detail", "VARCHAR", source_name="attributes_riskDetail"
            ),
            ...
            Column(
                "attributes_last_name", "VARCHAR", source_name="attributes_LastName"
            ),
            Column(
                "attributes_job_title", "VARCHAR", source_name="attributes_jobTitle"
            ),
            Column(
            ...
            Column(
                "attributes_sign_in_names",
                "VARCHAR",
                source_name="attributes_signInNames",
            ),
            Column(
                "attributes_iiqdisabled",
                "BOOLEAN",
                source_name="attributes_IIQDisabled",
            ),
            Column(
            ...
            Column(
                "attributes_account_enabled",
                "BOOLEAN",
                source_name="attributes_accountEnabled",
            ),
            Column(
            ...
            Column(
                "attributes_object_id", "VARCHAR", source_name="attributes_objectId"
            ),
            Column("attributes_state", "VARCHAR", source_name="attributes_state"),
            Column(
                "attributes_disabled_plans",
                "VARCHAR",
                source_name="attributes_disabledPlans",
            ),
            Column(
                "attributes_user_type", "VARCHAR", source_name="attributes_userType"
            ),
            Column(
                "attributes_creation_type",
                "VARCHAR",
                source_name="attributes_creationType",
            ),
            Column(
                "attributes_street_address",
                "VARCHAR",
                source_name="attributes_streetAddress",
            ),
            Column(
                "attributes_assigned_plans",
                "VARIANT",
                source_name="attributes_assignedPlans",
            ),
            Column(
                "attributes_telephone_number",
                "VARCHAR",
                source_name="attributes_telephoneNumber",
            ),
            Column(
            ...
            Column(
                "attributes_postal_code", "NUMBER", source_name="attributes_postalCode"
            ),
            Column("attributes_user_id", "VARCHAR", source_name="attributes_UserID"),
            Column(
                "attributes_display_name",
                "VARCHAR",
                source_name="attributes_displayName",
            ),
            Column(
                "attributes_system_role", "VARCHAR", source_name="attributes_systemRole"
            ),
            Column("attributes_mail", "VARCHAR", source_name="attributes_mail"),
            Column(
                "attributes_immutable_id",
                "VARCHAR",
                source_name="attributes_immutableId",
            ),
            Column(
                "attributes_given_name", "VARCHAR", source_name="attributes_givenName"
            ),
            Column(
                "attributes_dir_sync_enabled",
                "BOOLEAN",
                source_name="attributes_dirSyncEnabled",
            ),
            Column(
                "attributes_department", "VARCHAR", source_name="attributes_department"
            ),
            Column(
                "attributes_assigned_licenses",
                "VARIANT",
                source_name="attributes_assignedLicenses",
            ),
            Column(
                "attributes_other_mails", "VARIANT", source_name="attributes_otherMails"
            ),
            Column(
            ...
            Column(
                "attributes_mail_nickname",
                "VARCHAR",
                source_name="attributes_mailNickname",
            ),
            Column(
                "attributes_user_identities",
                "VARCHAR",
                source_name="attributes_userIdentities",
            ),
            Column("attributes_groups", "VARIANT", source_name="attributes_Groups"),
            Column(
                "attributes_usage_location",
                "VARCHAR",
                source_name="attributes_usageLocation",
            ),
            Column(
                "attributes_admin_of_sites",
                "VARCHAR",
                source_name="attributes_AdminOfSites",
            ),
            Column(
                "attributes_first_name", "VARCHAR", source_name="attributes_FirstName"
            ),
    ...
    Config(
        ...
        column_list=[
            Column(
                "identity_id", "VARCHAR", source_name="identity_id", uniqueness=True
            ),
            Column("id", "VARCHAR", source_name="id", uniqueness=True),
    ...
    Config(
        ...
        column_list=[
            ...
            Column(
                "attributes_iiq_disabled",
                "BOOLEAN",
                source_name="attributes_IIQDisabled",
            ),
            Column(
                "attributes_home_phone__c",
                "VARCHAR",
                source_name="attributes_home_phone__c",
            ),
            Column(
                "attributes_job_title__c",
                "VARCHAR",
                source_name="attributes_Job_Title__c",
            ),
            Column("attributes_state", "VARCHAR", source_name="attributes_STATE"),
            Column(
                "attributes_cost_center",
                "VARCHAR",
                source_name="attributes_COST_CENTER",
            ),
            Column(
            ...
            Column(
                "attributes_worker_type__c",
                "VARCHAR",
                source_name="attributes_Worker_Type__c",
            ),
            Column(
                "attributes_last_name", "VARCHAR", source_name="attributes_LAST_NAME"
            ),
            Column(
                "attributes_worker_name",
                "VARCHAR",
                source_name="attributes_WORKER_NAME",
            ),
            Column(
            ...
            Column(
                "attributes_first_name", "VARCHAR", source_name="attributes_FIRST_NAME"
            ),
            Column("attributes_country", "VARCHAR", source_name="attributes_COUNTRY"),
            Column(
            ...
            Column(
                "attributes_postal_code",
                "VARCHAR",
                source_name="attributes_POSTAL_CODE",
            ),
            Column("attributes_job_code", "VARCHAR", source_name="attributes_JOBCODE"),
            Column("attributes_user_id", "VARCHAR", source_name="attributes_USERID"),
            Column(
                "attributes_home_email__c",
                "VARCHAR",
                source_name="attributes_home_email__c",
            ),
            Column(
            ...
            Column(
                "attributes_domain_name__c",
                "VARCHAR",
                source_name="attributes_DomainName__c",
            ),
            Column(
                "attributes_address_line_1",
                "VARCHAR",
                source_name="attributes_ADDRESS_LINE_1",
            ),
            Column(
            ...
            Column(
                "attributes_full_part_time",
                "VARCHAR",
                source_name="attributes_FULLPARTTIME",
            ),
            Column(
                "attributes_wd_role_type__c",
                "VARCHAR",
                source_name="attributes_WD_Role_Type__c",
            ),
            Column(
            ...
            Column(
                "attributes_worker_status__c",
                "VARCHAR",
                source_name="attributes_Worker_Status__c",
            ),
            Column(
                "attributes_department", "VARCHAR", source_name="attributes_DEPARTMENT"
            ),
            Column(
                "attributes_ad_req__c", "BOOLEAN", source_name="attributes_ADReq__c"
            ),
            Column(
                "attributes_file_number", "NUMBER", source_name="attributes_FILENUMBER"
            ),
            Column(
                "attributes_manager_id", "NUMBER", source_name="attributes_MANAGER_ID"
            ),
            Column(
                "attributes_manager_id__c",
                "NUMBER",
                source_name="attributes_Manager_ID__c",
            ),
            Column(
                "attributes_employee_type",
                "VARCHAR",
                source_name="attributes_EMPLOYEE_TYPE",
            ),
            Column(
                "attributes_cost_center__c",
                "VARCHAR",
                source_name="attributes_Cost_Center__c",
            ),
            Column("attributes_city", "VARCHAR", source_name="attributes_CITY"),
            Column(
            ...
            Column(
                "attributes_manager_email__c",
                "VARCHAR",
                source_name="attributes_managerEmail__c",
            ),
            Column(
                "attributes_is_retail__c",
                "VARCHAR",
                source_name="attributes_is_retail__c",
            ),
            Column("attributes_hire_date", "DATE", source_name="attributes_HIREDATE"),
            Column(
                "attributes_address_work",
                "VARCHAR",
                source_name="attributes_ADDRESS_WORK",
            ),
            Column(
                "attributes_brand_id__c", "NUMBER", source_name="attributes_Brand_ID__c"
            ),
            Column(
                "attributes_retail_region__c",
                "VARCHAR",
                source_name="attributes_Retail_Region__c",
            ),
            Column(
                "attributes_job_title", "VARCHAR", source_name="attributes_JOBTITLE"
            ),
            Column(
                "attributes_email_work__c",
                "VARCHAR",
                source_name="attributes_Email_-_Work__c",
            ),
            Column(
                "attributes_middle_name",
                "VARCHAR",
                source_name="attributes_MIDDLE_NAME",
            ),
            Column(
    ...
    Config(
        ...
        column_list=[
            ...
            Column(
                ...
                "VARCHAR",
                source_name="requesterComment_comment",
            ),
            Column(
            ...
            Column(
                ...
                "VARCHAR",
                source_name="requesterComment_author_id",
            ),
            Column(
            ...
            Column(
                "requester_comment_created",
                "VARCHAR",
                source_name="requesterComment_created",
            ),
            Column(
                "previous_reviewers_comments",
                "VARCHAR",
                source_name="previousReviewersComments",
            ),
            Column("forward_history", "VARCHAR", source_name="forwardHistory"),
            Column("request_created", "VARCHAR", source_name="requestCreated"),
            Column(
                "requested_object_name", "VARCHAR", source_name="requestedObject_name"
            ),
            Column(
                "requested_object_description",
                "VARCHAR",
                source_name="requestedObject_description",
            ),
            Column(
                "requested_object_type", "VARCHAR", source_name="requestedObject_type"
            ),
            ...
            Column(
                ...
                "BOOLEAN",
                source_name="removeDateUpdateRequested",
            ),
            Column(
            ...
            Column(
                "sod_violation_context", "VARCHAR", source_name="sodViolationContext"
            ),
            Column(
