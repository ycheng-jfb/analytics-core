...
config_list = [
    ...
    # Page Models
    BuilderConfig(
        tfg_brand="Fabletics", content_type="account", public_key_conn_id="builder_fabletics"
    ),
    BuilderConfig(
        tfg_brand="Fabletics", content_type="landing-page", public_key_conn_id="builder_fabletics"
    ),
    BuilderConfig(
        tfg_brand="Fabletics", content_type="category-page", public_key_conn_id="builder_fabletics"
    ),
    BuilderConfig(
        tfg_brand="Fabletics", content_type="outlet", public_key_conn_id="builder_fabletics"
    ),
    BuilderConfig(
        tfg_brand="Fabletics", content_type="page", public_key_conn_id="builder_fabletics"
    ),
    # Section Models
    BuilderConfig(
        tfg_brand="Fabletics", content_type="header", public_key_conn_id="builder_fabletics"
    ),
    BuilderConfig(
        tfg_brand="Fabletics",
    ...
    BuilderConfig(
        tfg_brand="Fabletics", content_type="quiz-page", public_key_conn_id="builder_fabletics"
    ),
    # Structured Data Models
    BuilderConfig(
        tfg_brand="Fabletics", content_type="quiz-config", public_key_conn_id="builder_fabletics"
    ),
    # FabKids
    # Page Models
    BuilderConfig(
        tfg_brand="FabKids", content_type="landing-page", public_key_conn_id="builder_fabkids"
    ),
    BuilderConfig(tfg_brand="FabKids", content_type="page", public_key_conn_id="builder_fabkids"),
    # JustFab
    # Page Models
    BuilderConfig(
        tfg_brand="JustFab", content_type="landing-page", public_key_conn_id="builder_justfab"
    ),
    BuilderConfig(tfg_brand="JustFab", content_type="page", public_key_conn_id="builder_justfab"),
    # ShoeDazzle
    # Page Models
    BuilderConfig(
        tfg_brand="ShoeDazzle", content_type="landing-page", public_key_conn_id="builder_shoedazzle"
    ),
    BuilderConfig(
        tfg_brand="ShoeDazzle", content_type="page", public_key_conn_id="builder_shoedazzle"
    ),
    # SXF
    # Page Models
    BuilderConfig(tfg_brand="SXF", content_type="landing-page", public_key_conn_id="builder_sxf"),
    BuilderConfig(tfg_brand="SXF", content_type="page", public_key_conn_id="builder_sxf"),
    # Section Models
    BuilderConfig(tfg_brand="SXF", content_type="quiz", public_key_conn_id="builder_sxf"),
]
