...
config_list = [
    Config(
        ...
        column_list=[
            ...
            Column('grantee_type', 'VARCHAR', source_name='grantee_type', uniqueness=True),
    ...
    Config(
        ...
        column_list=[
            ...
            Column('use_remote_query_agent', 'VARCHAR', source_name='useRemoteQueryAgent'),
    ...
    Config(
        ...
        column_list=[
            Column('id', 'VARCHAR', source_name='id', uniqueness=True),
            Column('workbook_id', 'VARCHAR', source_name='workbook_id', uniqueness=True),
            Column('type', 'VARCHAR', source_name='type'),
            ...
            Column('query_tagging_enabled', 'VARCHAR', source_name='queryTaggingEnabled'),
