...
class SamConfig:
    ...
    sam_column_list = [
        ...
        Column('membership_brand_id', 'VARCHAR', source_name='_source_membership_brand_id'),
        Column('master_store_group_id', 'VARCHAR', source_name='_source_master_store_group_id'),
        ...
        Column('datetime_added_sam', 'TIMESTAMP_LTZ(3)', source_name='_source_datetime_added'),
        Column(
            'datetime_modified_sam', 'TIMESTAMP_LTZ(3)', source_name='_source_datetime_modified'
        ),
...
def get_hourly_query(watermark_operator):
    return {
        "bool": {
            "must": [
                {"range": {"datetime_modified": {"gt": watermark_operator.low_watermark}}},
                {"term": {"_type": "_doc"}},
            ]
        }
    }
