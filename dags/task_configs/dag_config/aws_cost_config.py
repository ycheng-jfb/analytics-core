...
column_list = [
    Column('identity_line_item_id', 'VARCHAR', source_name='identity/LineItemId', uniqueness=True),
    ...
    Column(
        'bill_billing_period_end_date', 'TIMESTAMP_LTZ(3)', source_name='bill/BillingPeriodEndDate'
    ),
    Column('line_item_usage_account_id', 'NUMBER', source_name='lineItem/UsageAccountId'),
    Column('line_item_line_item_type', 'VARCHAR', source_name='lineItem/LineItemType'),
    Column('line_item_usage_start_date', 'TIMESTAMP_LTZ(3)', source_name='lineItem/UsageStartDate'),
    Column('line_item_usage_end_date', 'TIMESTAMP_LTZ(3)', source_name='lineItem/UsageEndDate'),
    ...
    Column('line_item_availability_zone', 'VARCHAR', source_name='lineItem/AvailabilityZone'),
    Column('line_item_resource_id', 'VARCHAR', source_name='lineItem/ResourceId'),
    Column('line_item_usage_amount', 'NUMBER(38,10)', source_name='lineItem/UsageAmount'),
    Column('line_item_normalization_factor', 'VARCHAR', source_name='lineItem/NormalizationFactor'),
    Column(
        'line_item_normalized_usage_amount', 'VARCHAR', source_name='lineItem/NormalizedUsageAmount'
    ),
    Column('line_item_currency_code', 'VARCHAR', source_name='lineItem/CurrencyCode'),
    Column('line_item_unblended_rate', 'NUMBER(38,10)', source_name='lineItem/UnblendedRate'),
    Column('line_item_unblended_cost', 'NUMBER(38,10)', source_name='lineItem/UnblendedCost'),
    Column('line_item_blended_rate', 'NUMBER(38,10)', source_name='lineItem/BlendedRate'),
    Column('line_item_blended_cost', 'NUMBER(38,10)', source_name='lineItem/BlendedCost'),
    Column(
        'line_item_line_item_description', 'VARCHAR', source_name='lineItem/LineItemDescription'
    ),
    ...
    Column('product_account_assistance', 'VARCHAR', source_name='product/accountAssistance'),
    Column('product_alarm_type', 'VARCHAR', source_name='product/alarmType'),
    Column('product_architectural_review', 'VARCHAR', source_name='product/architecturalReview'),
    Column('product_architecture_support', 'VARCHAR', source_name='product/architectureSupport'),
    ...
    Column('product_availability_zone', 'VARCHAR', source_name='product/availabilityZone'),
    ...
    Column('product_current_generation', 'VARCHAR', source_name='product/currentGeneration'),
    Column(
    ...
    Column(
        'product_dedicated_ebs_throughput', 'VARCHAR', source_name='product/dedicatedEbsThroughput'
    ),
    Column('product_deployment_option', 'VARCHAR', source_name='product/deploymentOption'),
    Column('product_description', 'VARCHAR', source_name='product/description'),
    Column(
        'product_direct_connect_location', 'VARCHAR', source_name='product/directConnectLocation'
    ),
    ...
    Column('product_equivalentondemandsku', 'VARCHAR', source_name='product/equivalentondemandsku'),
    ...
    Column('product_from_location_type', 'VARCHAR', source_name='product/fromLocationType'),
    ...
    Column('product_group_description', 'VARCHAR', source_name='product/groupDescription'),
    Column('product_included_services', 'VARCHAR', source_name='product/includedServices'),
    ...
    Column('product_instance_type_family', 'VARCHAR', source_name='product/instanceTypeFamily'),
    Column('product_intel_avx_2_available', 'VARCHAR', source_name='product/intelAvx2Available'),
    Column('product_intel_avx_available', 'VARCHAR', source_name='product/intelAvxAvailable'),
    Column('product_intel_turbo_available', 'VARCHAR', source_name='product/intelTurboAvailable'),
    ...
    Column('product_logs_destination', 'VARCHAR', source_name='product/logsDestination'),
    ...
    Column('product_max_throughputvolume', 'VARCHAR', source_name='product/maxThroughputvolume'),
    Column('product_max_volume_size', 'VARCHAR', source_name='product/maxVolumeSize'),
    Column('product_maximum_capacity', 'VARCHAR', source_name='product/maximumCapacity'),
    Column(
        'product_maximum_extended_storage', 'VARCHAR', source_name='product/maximumExtendedStorage'
    ),
    ...
    Column('product_message_delivery_order', 'VARCHAR', source_name='product/messageDeliveryOrder'),
    Column('product_min_volume_size', 'VARCHAR', source_name='product/minVolumeSize'),
    Column('product_network_performance', 'VARCHAR', source_name='product/networkPerformance'),
    Column(
        'product_normalization_size_factor',
        'VARCHAR',
        source_name='product/normalizationSizeFactor',
    ),
    Column('product_operating_system', 'VARCHAR', source_name='product/operatingSystem'),
    Column('product_operation', 'VARCHAR', source_name='product/operation'),
    Column('product_operations_support', 'VARCHAR', source_name='product/operationsSupport'),
    ...
    Column('product_physical_processor', 'VARCHAR', source_name='product/physicalProcessor'),
    Column(
        'product_platoclassificationtype', 'VARCHAR', source_name='product/platoclassificationtype'
    ),
    Column('product_platoinstancename', 'VARCHAR', source_name='product/platoinstancename'),
    Column('product_platoinstancetype', 'VARCHAR', source_name='product/platoinstancetype'),
    Column('product_platopricingtype', 'VARCHAR', source_name='product/platopricingtype'),
    Column('product_platoprotocoltype', 'VARCHAR', source_name='product/platoprotocoltype'),
    Column('product_platostoragetype', 'VARCHAR', source_name='product/platostoragetype'),
    Column('product_platotrafficdirection', 'VARCHAR', source_name='product/platotrafficdirection'),
    Column('product_platotransfertype', 'VARCHAR', source_name='product/platotransfertype'),
    ...
    Column('product_proactive_guidance', 'VARCHAR', source_name='product/proactiveGuidance'),
    Column(
        'product_processor_architecture', 'VARCHAR', source_name='product/processorArchitecture'
    ),
    Column('product_processor_features', 'VARCHAR', source_name='product/processorFeatures'),
    ...
    Column('product_request_description', 'VARCHAR', source_name='product/requestDescription'),
    Column('product_request_type', 'VARCHAR', source_name='product/requestType'),
    Column('product_resource_endpoint', 'VARCHAR', source_name='product/resourceEndpoint'),
    ...
    Column('product_standard_storage', 'VARCHAR', source_name='product/standardStorage'),
    Column(
    ...
    Column('product_storage_description', 'VARCHAR', source_name='product/storageDescription'),
    ...
    Column('product_technical_support', 'VARCHAR', source_name='product/technicalSupport'),
    ...
    Column('product_virtual_interface_type', 'VARCHAR', source_name='product/virtualInterfaceType'),
    ...
    Column('product_vpcnetworkingsupport', 'VARCHAR', source_name='product/vpcnetworkingsupport'),
    Column('product_who_can_open_cases', 'VARCHAR', source_name='product/whoCanOpenCases'),
    Column('pricing_lease_contract_length', 'VARCHAR', source_name='pricing/LeaseContractLength'),
    ...
    Column(
        'pricing_public_on_demand_cost', 'NUMBER(38,10)', source_name='pricing/publicOnDemandCost'
    ),
    Column(
        'pricing_public_on_demand_rate', 'NUMBER(38,10)', source_name='pricing/publicOnDemandRate'
    ),
    ...
    Column('reservation_effective_cost', 'VARCHAR', source_name='reservation/EffectiveCost'),
    Column('reservation_end_time', 'VARCHAR', source_name='reservation/EndTime'),
    Column(
        'reservation_modification_status', 'VARCHAR', source_name='reservation/ModificationStatus'
    ),
    Column(
    ...
    Column('reservation_subscription_id', 'VARCHAR', source_name='reservation/SubscriptionId'),
    Column(
    ...
    Column(
        'reservation_total_reserved_units', 'VARCHAR', source_name='reservation/TotalReservedUnits'
    ),
    Column(
    ...
    Column('reservation_unused_quantity', 'VARCHAR', source_name='reservation/UnusedQuantity'),
    Column(
        'reservation_unused_recurring_fee', 'VARCHAR', source_name='reservation/UnusedRecurringFee'
    ),
    Column('reservation_upfront_value', 'VARCHAR', source_name='reservation/UpfrontValue'),
    Column(
        'savings_plan_total_commitment_to_date',
        'VARCHAR',
        source_name='savingsPlan/TotalCommitmentToDate',
    ),
    Column('savings_plan_savings_plan_arn', 'VARCHAR', source_name='savingsPlan/SavingsPlanARN'),
    Column('savings_plan_savings_plan_rate', 'VARCHAR', source_name='savingsPlan/SavingsPlanRate'),
    Column('savings_plan_used_commitment', 'VARCHAR', source_name='savingsPlan/UsedCommitment'),
    Column(
    ...
    Column('savings_plan_offering_type', 'VARCHAR', source_name='savingsPlan/OfferingType'),
    Column('savings_plan_payment_option', 'VARCHAR', source_name='savingsPlan/PaymentOption'),
    Column('savings_plan_purchase_term', 'VARCHAR', source_name='savingsPlan/PurchaseTerm'),
    ...
    Column('resource_tags_aws_created_by', 'VARCHAR', source_name='resourceTags/aws:createdBy'),
    Column(
        'resource_tags_aws_ec2_fleet_id', 'VARCHAR', source_name='resourceTags/aws:ec2:fleet-id'
    ),
    Column(
    ...
    Column('resource_tags_user_account_id', 'VARCHAR', source_name='resourceTags/user:AccountId'),
    Column(
        '"resource_tags_user_Application"', 'VARCHAR', source_name='resourceTags/user:Application'
    ),
    Column(
    ...
    Column('resource_tags_user_billedto', 'VARCHAR', source_name='resourceTags/user:BILLEDTO'),
    Column('resource_tags_user_cluster_id', 'VARCHAR', source_name='resourceTags/user:ClusterId'),
    Column(
        'resource_tags_user_cluster_name', 'VARCHAR', source_name='resourceTags/user:ClusterName'
    ),
    Column(
    ...
    Column(
        'resource_tags_user_description', 'VARCHAR', source_name='resourceTags/user:Description'
    ),
    Column(
        'resource_tags_user_git_2_ebdemo', 'VARCHAR', source_name='resourceTags/user:Git2EBDemo'
    ),
    Column('resource_tags_user_name', 'VARCHAR', source_name='resourceTags/user:Name'),
    Column('"resource_tags_user_Owner"', 'VARCHAR', source_name='resourceTags/user:Owner'),
    Column('"resource_tags_user_Project"', 'VARCHAR', source_name='resourceTags/user:Project'),
    Column('resource_tags_user_stage', 'VARCHAR', source_name='resourceTags/user:STAGE'),
    Column('resource_tags_user_ticket', 'VARCHAR', source_name='resourceTags/user:Ticket'),
    Column(
        '"resource_tags_user_account-id"', 'VARCHAR', source_name='resourceTags/user:account-id'
    ),
    Column('resource_tags_user_api', 'VARCHAR', source_name='resourceTags/user:api'),
    Column(
        '"resource_tags_user_api gateway"', 'VARCHAR', source_name='resourceTags/user:api gateway'
    ),
    Column(
        'resource_tags_user_api_gateway', 'VARCHAR', source_name='resourceTags/user:api_gateway'
    ),
    Column('resource_tags_user_app', 'VARCHAR', source_name='resourceTags/user:app'),
    Column('resource_tags_user_app_name', 'VARCHAR', source_name='resourceTags/user:app-name'),
    Column(
        'resource_tags_user_application', 'VARCHAR', source_name='resourceTags/user:application'
    ),
    Column(
    ...
    Column('resource_tags_user_department', 'VARCHAR', source_name='resourceTags/user:department'),
    Column(
    ...
    Column(
        'resource_tags_user_environment', 'VARCHAR', source_name='resourceTags/user:environment'
    ),
    Column(
    ...
    Column('resource_tags_user_username', 'VARCHAR', source_name='resourceTags/user:username'),
