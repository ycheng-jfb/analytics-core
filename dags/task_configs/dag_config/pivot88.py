...
column_list_adv_details = [
    Column('INSPECTION_ID', 'NUMBER', source_name='assignments_items_id', uniqueness=True),
    Column('ASSIGNMENT_GROUP', 'NUMBER', source_name='assignment_group_id', uniqueness=True),
    Column('PO_NUMBER', 'VARCHAR', source_name='assignments_items_po_line_po_id', uniqueness=True),
    ...
    Column('INSPECTION_STATUS', 'VARCHAR', source_name='assignments_items_inspection_status_text'),
    Column('INSPECTION_RESULT', 'VARCHAR', source_name='assignments_items_inspection_result_text'),
    ...
    Column('VENDOR_NAME', 'VARCHAR', source_name='assignments_items_po_line_po_suppliers_name'),
    Column(
        'ERP_BUSINESS_ID',
        'NUMBER',
    ...
    Column('ITEM_NAME', 'VARCHAR', source_name='assignments_items_po_line_sku_item_name'),
    Column('ITEM_CATEGORY', 'VARCHAR', source_name='assignments_items_po_line_sku_product_family'),
    Column('ITEM_DEPARTMENT', 'VARCHAR', source_name='assignments_items_po_line_department'),
    Column('DESTINATION_REGION', 'VARCHAR', source_name='assignments_items_po_line_region'),
    Column(
        'DEFECT_DESCRIPTION',
        'VARCHAR',
    ...
    Column('GROUP_INSPECTED_QTY', 'NUMBER', source_name='assignments_items_qty_inspected'),
    Column(
        'CRITICAL_DEFECTS',
        'NUMBER',
