...
metadata_config = Config(
    ...
    column_list=[
        ...
        Column('dam_physicalheightininches', 'VARCHAR', source_name='damPhysicalheightininches'),
        Column('tiff_compression', 'VARCHAR', source_name='tiffCompression'),
        Column('tiff_make', 'VARCHAR', source_name='tiffMake'),
        Column('dam_physicalwidthininches', 'VARCHAR', source_name='damPhysicalwidthininches'),
        Column('exif_exlens_specification', 'VARCHAR', source_name='exifEXLensSpecification'),
        Column(
        ...
        Column('photoshop_date_created', 'TIMESTAMP_LTZ(3)', source_name='photoshopDateCreated'),
        ...
        Column('tiff_planar_configuration', 'VARCHAR', source_name='tiffPlanarConfiguration'),
        ...
        Column('exif_shutter_speed_value', 'VARCHAR', source_name='exifShutterSpeedValue'),
        ...
        Column('photoshop_instructions', 'VARCHAR', source_name='photoshopInstructions'),
        Column('exif_exlens_serial_number', 'VARCHAR', source_name='exifEXLensSerialNumber'),
        ...
        Column('exif_focal_plane_xresolution', 'VARCHAR', source_name='exifFocalPlaneXResolution'),
        Column('dam_special_instructions', 'VARCHAR', source_name='damSpecialInstructions'),
        ...
        Column('exif_exsensitivity_type', 'VARCHAR', source_name='exifEXSensitivityType'),
        ...
        Column('photoshop_document_ancestors', 'VARCHAR', source_name='photoshopDocumentAncestors'),
        ...
        Column('dam_physical_width_in_dpi', 'NUMBER', source_name='damPhysicalwidthindpi'),
        Column('photoshop_source', 'VARCHAR', source_name='photoshopSource'),
        Column('dam_physical_height_in_dpi', 'NUMBER', source_name='damPhysicalheightindpi'),
        ...
        Column('xmp_mmoriginal_document_id', 'VARCHAR', source_name='xmpMMOriginalDocumentID'),
        ...
        Column('exif_exposure_bias_value', 'VARCHAR', source_name='exifExposureBiasValue'),
        Column('xmp_metadata_date', 'TIMESTAMP_LTZ(3)', source_name='xmpMetadataDate'),
        Column('exif_exbody_serial_number', 'NUMBER', source_name='exifEXBodySerialNumber'),
        ...
        Column('dam_numberoftextualcomments', 'VARCHAR', source_name='damNumberoftextualcomments'),
        Column(
        ...
        Column('exif_date_time_original', 'TIMESTAMP_LTZ(3)', source_name='exifDateTimeOriginal'),
        Column('dam_digital_creation_date', 'VARCHAR', source_name='damDigitalCreationDate'),
        Column('photoshop_legacy_iptcdigest', 'VARCHAR', source_name='photoshopLegacyIPTCDigest'),
        ...
        Column('exif_focal_plane_yresolution', 'VARCHAR', source_name='exifFocalPlaneYResolution'),
        Column(
        ...
        Column('ps_aux_lens_serial_number', 'VARCHAR', source_name='psAuxLensSerialNumber'),
        ...
        Column('exif_scene_capture_type', 'VARCHAR', source_name='exifSceneCaptureType'),
        ...
        Column('ps_aux_flash_compensation', 'VARCHAR', source_name='psAuxFlashCompensation'),
        Column(
