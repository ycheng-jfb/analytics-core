...
javascript_fk_schema = StructType(
    [
        StructField(
            "_metadata",
            StructType(
        ...
        StructField(
            ...
            StructType(
                [
                    StructField("HDYH", StringType(), True),
                    StructField("activated_date", StringType(), True),
                    StructField("birthday", StringType(), True),
                    StructField("email", StringType(), True),
                    StructField("gender", StringType(), True),
                    StructField("kid_bottom_sizes", ArrayType(StringType()), True),
                    StructField("kid_favorite_colors", ArrayType(StringType()), True),
                    StructField("kid_genders", ArrayType(StringType()), True),
