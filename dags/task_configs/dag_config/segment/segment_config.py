...
from task_configs.dag_config.segment.java_fl_ecom_mobile_app import (
    java_fl_ecom_mobile_app_schema,
)
from task_configs.dag_config.segment.java_jf import java_jf_schema
from task_configs.dag_config.segment.java_jf_ecom_mobile_app import (
    java_jf_ecom_mobile_app_schema,
)
