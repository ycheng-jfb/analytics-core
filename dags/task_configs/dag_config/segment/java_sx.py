...
java_sx_schema = StructType(
    [
        ...
        StructField(
            ...
            StructType(
                [
                    StructField("bundle_action", StringType(), True),
                    StructField("coupons", StringType(), True),
                    StructField("autogenerated_password", BooleanType(), True),
        ...
        StructField("tarits", StringType(), True),
    ]
)
