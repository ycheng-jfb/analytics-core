...
class HvrConfig:
    ...
    def get_task_id(self):
        if self.table_group != "":
            task_id = (
                f"alert_for_hvr_{self.lake_db}_{self.table_group}_{self.minute_window}"
            )
        else:
...
non_hvr_config_list = [
    ...
    NonHvrConfig(
        "lake_fivetran.med_facebook_ads_30min_eu_v1.ad_insights_by_hour",
        "_fivetran_synced",
        120,
    ),
    NonHvrConfig(
        "lake_fivetran.med_facebook_ads_30min_na_v1.ad_insights_by_hour",
        "_fivetran_synced",
        120,
    ),
    ...
    NonHvrConfig(
        "lake.segment_fl.java_fabletics_ecom_mobile_app_product_added",
        "meta_create_datetime",
        120,
    ),
    NonHvrConfig(
        "lake.segment_fl.java_fabletics_ecom_mobile_app_signed_in",
        "meta_create_datetime",
        120,
    ),
    NonHvrConfig(
        "lake.segment_fl.java_fabletics_order_completed", "meta_create_datetime", 120
    ),
    NonHvrConfig(
        "lake.segment_fl.java_fabletics_product_added", "meta_create_datetime", 120
    ),
    NonHvrConfig(
        "lake.segment_fl.java_fabletics_signed_in", "meta_create_datetime", 120
    ),
    NonHvrConfig(
        "lake.segment_fl.javascript_fabletics_page", "meta_create_datetime", 120
    ),
    NonHvrConfig(
    ...
    NonHvrConfig(
        "lake.segment_fl.react_native_fabletics_screen", "meta_create_datetime", 120
    ),
    NonHvrConfig(
    ...
    NonHvrConfig(
        "lake.segment_gfb.java_fabkids_order_completed", "meta_create_datetime", 120
    ),
    NonHvrConfig(
        "lake.segment_gfb.java_fabkids_product_added", "meta_create_datetime", 120
    ),
    NonHvrConfig(
        "lake.segment_gfb.java_fabkids_signed_in", "meta_create_datetime", 120
    ),
    NonHvrConfig(
        "lake.segment_gfb.java_jf_ecom_app_order_completed", "meta_create_datetime", 120
    ),
    NonHvrConfig(
        "lake.segment_gfb.java_jf_ecom_app_product_added", "meta_create_datetime", 120
    ),
    NonHvrConfig(
        "lake.segment_gfb.java_jf_ecom_app_signed_in", "meta_create_datetime", 120
    ),
    NonHvrConfig(
    ...
    NonHvrConfig(
        "lake.segment_gfb.java_justfab_order_completed", "meta_create_datetime", 120
    ),
    NonHvrConfig(
        "lake.segment_gfb.java_justfab_product_added", "meta_create_datetime", 120
    ),
    NonHvrConfig(
        "lake.segment_gfb.java_justfab_signed_in", "meta_create_datetime", 120
    ),
    NonHvrConfig(
    ...
    NonHvrConfig(
        "lake.segment_gfb.java_shoedazzle_order_completed", "meta_create_datetime", 120
    ),
    NonHvrConfig(
        "lake.segment_gfb.java_shoedazzle_product_added", "meta_create_datetime", 120
    ),
    NonHvrConfig(
        "lake.segment_gfb.java_shoedazzle_signed_in", "meta_create_datetime", 120
    ),
    NonHvrConfig(
        "lake.segment_gfb.javascript_fabkids_page", "meta_create_datetime", 120
    ),
    NonHvrConfig(
    ...
    NonHvrConfig(
        "lake.segment_gfb.javascript_justfab_page", "meta_create_datetime", 120
    ),
    NonHvrConfig(
    ...
    NonHvrConfig(
        "lake.segment_gfb.javascript_shoedazzle_page", "meta_create_datetime", 120
    ),
    NonHvrConfig(
    ...
    NonHvrConfig(
        "lake.segment_gfb.react_native_justfab_screen", "meta_create_datetime", 120
    ),
    NonHvrConfig(
        "lake.segment_sxf.java_sxf_complete_registration", "meta_create_datetime", 120
    ),
    NonHvrConfig(
        "lake.segment_sxf.java_sxf_order_completed", "meta_create_datetime", 120
    ),
    NonHvrConfig(
        "lake.segment_sxf.java_sxf_product_added", "meta_create_datetime", 120
    ),
    ...
    NonHvrConfig(
        "lake.segment_sxf.javascript_sxf_product_viewed", "meta_create_datetime", 120
    ),
    # Lake_Consolidated High Freq Critical Tables
    NonHvrConfig("lake_consolidated.ultra_merchant.cart", "meta_update_datetime", 1680),
    NonHvrConfig(
        "lake_consolidated.ultra_merchant.customer", "meta_update_datetime", 240
    ),
    NonHvrConfig(
        "lake_consolidated.ultra_merchant.membership", "meta_update_datetime", 240
    ),
    NonHvrConfig(
        'lake_consolidated.ultra_merchant."ORDER"', "meta_update_datetime", 240
    ),
    NonHvrConfig(
        "lake_consolidated.ultra_merchant.session", "meta_update_datetime", 240
    ),
    # EDW Layer
