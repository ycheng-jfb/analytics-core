...
dag = DAG(
    'all_channel_optimization',   # DAG任务名   建议python 脚本名字，DAG任务名，sql脚本名三者统一
    default_args=default_args,
    # schedule_interval="@daily",  # 启用每日调度
    schedule_interval="0 8 * * *",  # 每天早上6点
...
run_sql_file = SnowflakeOperator(
    task_id='all_channel_optimization',
    sql='sql/all_channel_optimization.sql',  # 执行脚本的相对路径
