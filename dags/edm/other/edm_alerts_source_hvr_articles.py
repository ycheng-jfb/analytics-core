...
with dag:
    alert_check_for_missing_evo_articles = MsSqlAlertOperator(
        ...
        sql_or_path=Path(SQL_DIR, 'util', 'procedures', 'mssql.evolve_articles_checker.sql'),
        alert_type='mail',
        subject="Alert: Missing Articles on EVOLVE01 SQL Server!",
        body=("The following tables are missing Articles and changes can't be picked up by HVR!"),
    ...
    alert_check_for_missing_jfb_articles = MsSqlAlertOperator(
        ...
        sql_or_path=Path(SQL_DIR, 'util', 'procedures', 'mssql.jfb_articles_checker.sql'),
        alert_type='mail',
    ...
    alert_check_for_missing_fbl_articles = MsSqlAlertOperator(
        ...
        sql_or_path=Path(SQL_DIR, 'util', 'procedures', 'mssql.fbl_articles_checker.sql'),
        alert_type='mail',
    ...
    alert_check_for_missing_sxf_articles = MsSqlAlertOperator(
        ...
        sql_or_path=Path(SQL_DIR, 'util', 'procedures', 'mssql.sxf_articles_checker.sql'),
        alert_type='mail',
