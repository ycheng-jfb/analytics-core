    ...
    return SnowflakeMartFactOperator(
        ...
        column_list=[
            ...
            Column(
                ...
                key_lookup_list=[
                    KeyLookupJoin(stg_column='refund_reason', stg_column_type='VARCHAR(255)')
                ],
            ),
            Column(
                'refund_comment_key',
                ...
                key_lookup_list=[
                    KeyLookupJoin(stg_column='refund_comment', stg_column_type='VARCHAR(255)')
                ],
            ),
            Column(
                'refund_status_key',
                ...
                key_lookup_list=[
                    KeyLookupJoin(stg_column='refund_status_code', stg_column_type='INT')
                ],
            ),
            Column(
