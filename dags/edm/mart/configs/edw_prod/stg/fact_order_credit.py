...
def get_mart_operator():
    return SnowflakeMartFactOperator(
        ...
        column_list=[
            ...
            Column(
                "billed_cash_credit_redeemed_same_month_local_amount", "NUMBER(19,4)"
            ),
            Column("billed_cash_credit_redeemed_equivalent_count", "NUMBER(19,4)"),
            Column(
                "billed_cash_credit_sub_credit_redeemed_local_amount", "NUMBER(19,4)"
            ),
            Column(
            ...
            Column(
                "billed_cash_credit_sub_token_redeemed_local_amount", "NUMBER(19,4)"
            ),
            Column(
            ...
            Column(
                "other_cash_credit_sub_gift_card_redeemed_local_amount", "NUMBER(19,4)"
            ),
            Column(
            ...
            Column(
                "refund_cash_credit_sub_credit_redeemed_local_amount", "NUMBER(19,4)"
            ),
            Column(
                "refund_cash_credit_sub_token_redeemed_local_amount", "NUMBER(19,4)"
            ),
            ...
            Column(
                "noncash_credit_sub_gift_card_redeemed_local_amount", "NUMBER(19,4)"
            ),
