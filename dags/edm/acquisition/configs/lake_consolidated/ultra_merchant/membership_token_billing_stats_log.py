...
table_config = TableConfig(
    table='membership_token_billing_stats_log',
    company_join_sql="""
        SELECT DISTINCT
        ...
        INNER JOIN {database}.{source_schema}.membership_token_billing_stats_log AS L
    ...
    column_list=[
        ...
        Column('total_credited_on_demand', 'INT'),
        Column('total_credited_today', 'INT'),
        Column('total_credited_on_demand_today', 'INT'),
