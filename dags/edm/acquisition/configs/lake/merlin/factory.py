...
table_config = TableConfig(
    ...
    column_list=[
        ...
        Column(
            "official_factory_name", "VARCHAR(100)", source_name="OfficialFactoryName"
        ),
        Column("vendor", "INT", source_name="Vendor"),
        Column("phone_number", "VARCHAR(15)", source_name="PhoneNumber"),
        Column(
            "factory_email_address", "VARCHAR(100)", source_name="FactoryEmailAddress"
        ),
        Column(
            "contact_email_address", "VARCHAR(100)", source_name="ContactEmailAddress"
        ),
