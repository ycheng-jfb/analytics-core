...
table_config = TableConfig(
    ...
    column_list=[
        Column('shipping_port_id', 'INT', uniqueness=True, source_name='ShippingPortId'),
        ...
        Column('preferred_dow_origin_country_id', 'INT', source_name='PreferredDOWOriginCountryId'),
    ],
)
