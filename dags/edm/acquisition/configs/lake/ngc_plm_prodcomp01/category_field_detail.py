...
table_config = TableConfig(
    ...
    schema='dbo',
    table='CategoryFieldDetail',
    high_watermark_cls=HighWatermarkMaxVarcharDatetimeOffset,
    watermark_column='ModifiedOn',
    schema_version_prefix='v2',
    column_list=[
        Column(
            'id_category_field_detail', 'INT', uniqueness=True, source_name='ID_CategoryFieldDetail'
        ),
        ...
        Column('id_category_field', 'INT', source_name='ID_CategoryField'),
        Column('id_category_field_entity', 'INT', source_name='ID_CategoryFieldEntity'),
    ],
)
