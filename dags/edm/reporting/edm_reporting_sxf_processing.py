...
with dag:
    ...
    sxf_max_date_slack_alert = SnowflakeAlertOperator(
        ...
        sql_or_path=Path(
            SQL_DIR, "reporting_prod", "procedures", "validation.sxf_max_date.sql"
        ),
        subject="SXF max_date slack alert",
        body="Below is the list of unrefreshed SXF tables",
        distribution_list=[
            "sxf-data-team-intake-aaaafsjwvsjonwlklilp4qtfcm@techstyle.slack.com"
        ],
    ...
    (
        ...
        >> pcvr_product_psource_reduced
        >> pcvr_product_psource_reduced_tableau
    )
