...
def trigger_dag(**kwargs):
    ...
    if execution_time.minute == 40:
        return [
            trigger_med61_hourly_projections.task_id,
            med61_validation_check.task_id,
        ]
...
with dag:
    ...
    med61_validation_check = SnowflakeAlertOperator(
        ...
        sql_or_path=Path(
            ...
            "reporting_base_prod",
            "procedures",
            "shared.med61_metrics_validation.sql",
        ),
        distribution_list=[],
    ...
    tableau_refresh_med_61 = TableauRefreshOperator(
        data_source_id="998e517f-917b-4ad5-8d58-5777e706376f",
        task_id="med61-tableau-refresh",
    )

    tableau_refresh_med_61_order = TableauRefreshOperator(
        data_source_name="Real Time Order Metrics",
