...
default_args = {
    ...
    "email": email_lists.data_integration_support + email_lists.fabletics_analytics_support,
...
with dag:
    ...
    fol_extended_missing_order_number_alert = SnowflakeAlertOperator(
        ...
        sql_or_path=Path(
            SQL_DIR, 'util', 'procedures', 'fabletics.fol_extended_missing_order_lines.sql'
        ),
    )
