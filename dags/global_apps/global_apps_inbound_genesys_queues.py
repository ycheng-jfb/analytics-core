...
column_list = [
    ...
    Column('dateModified', 'TIMESTAMP_NTZ(3)', source_name='date_modified', delta_column=0),
    ...
    Column(
        'suppressInQueueCallRecording', 'Boolean', source_name='suppress_inqueue_call_recording'
    ),
