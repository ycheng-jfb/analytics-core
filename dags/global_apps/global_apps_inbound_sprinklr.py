...
sprinklr_configs = [
    SprinklrConfig(
        ...
        column_list=[
            Column(
                'case_creation_time', 'TIMESTAMP_LTZ(7)', source_name='DATE_TYPE_CASE_CREATION_TIME'
            ),
            Column('case_id', 'int', uniqueness=True, source_name='CASE_ID'),
            Column('handled_by', 'string', source_name='UNIVERSAL_CASE_CUSTOM_PROPERTY'),
            Column('initial_routing_team', 'string', source_name='UNIVERSAL_CASE_CUSTOM_PROPERTY1'),
            ...
            Column('is_dark_post', 'string', source_name='UNIVERSAL_CASE_CUSTOM_PROPERTY4'),
            Column('case_count', 'float', source_name='CASE_COUNT'),
            Column('retention_case_count', 'float', source_name='RETENTION_CASE_COUNT2063'),
    ...
    SprinklrConfig(
        ...
        column_list=[
            Column(
                'case_marco_apply_time', 'TIMESTAMP_LTZ(7)', source_name='CASE_MACRO_APPLY_TIME'
            ),
            Column('case_id', 'int', uniqueness=True, source_name='CASE_ID'),
            ...
            Column('social_network', 'string', source_name='UNIVERSAL_CASE_CUSTOM_PROPERTY3'),
            Column('initial_message_type', 'string', source_name='UNIVERSAL_CASE_CUSTOM_PROPERTY4'),
            Column('status', 'string', source_name='UNIVERSAL_CASE_CUSTOM_PROPERTY5'),
            Column('handled_by', 'string', source_name='UNIVERSAL_CASE_CUSTOM_PROPERTY6'),
            Column('is_dark_post', 'string', source_name='UNIVERSAL_CASE_CUSTOM_PROPERTY7'),
            Column('case_macro_usage_count', 'float', source_name='CASE_MACRO_USAGE_COUNT'),
            Column('load_time', 'TIMESTAMP_LTZ(7)', delta_column=True),
        ],
    ),
    SprinklrConfig(
        ...
        column_list=[
            ...
            Column('case_count', 'float', source_name='CASE_COUNT'),
            Column('load_time', 'TIMESTAMP_LTZ(7)', delta_column=True),
            Column('last_engaged_user', 'string', source_name='UNIVERSAL_CASE_CUSTOM_PROPERTY8'),
        ],
        look_back_period=14 * 24 * 60 * 60 * 1000,
    ),
    SprinklrConfig(
        ...
        column_list=[
            ...
            Column('social_network', 'string', source_name='UNIVERSAL_CASE_CUSTOM_PROPERTY2'),
            Column('initial_message_type', 'string', source_name='UNIVERSAL_CASE_CUSTOM_PROPERTY3'),
            Column(
    ...
    SprinklrConfig(
        ...
        column_list=[
            ...
            Column('affected_user_id', 'string', source_name='AFFECTED_USER_ID', uniqueness=True),
            Column(
            ...
            Column('unique_cases_assigned', 'float', source_name='UNIQUE_CASES_ASSIGNED'),
            Column('load_time', 'TIMESTAMP_LTZ(7)', delta_column=0),
        ],
    ),
    SprinklrConfig(
        ...
        column_list=[
            ...
            Column('published_message_count', 'float', source_name='PUBLISHED_MESSAGE_COUNT'),
            Column('load_time', 'TIMESTAMP_LTZ(7)', delta_column=0),
        ],
    ...
    SprinklrConfig(
        ...
        column_list=[
            ...
            Column(
                'country', 'string', source_name='UNIVERSAL_CASE_CUSTOM_PROPERTY_4', uniqueness=True
            ),
            Column(
            ...
            Column('load_time', 'TIMESTAMP_LTZ(7)', source_name='load_time', delta_column=0),
        ],
        extract_case_id=False,
        look_back_period=30 * 24 * 60 * 60 * 1000,
        time_increment=30 * 24 * 60 * 60 * 1000,
    ...
    SprinklrConfig(
        ...
        column_list=[
            Column('case_creation_time', 'string', source_name='DATE_TYPE_CASE_CREATION_TIME'),
            Column('case_id', 'int', uniqueness=True, source_name='CASE_ID'),
            Column('case_text', 'string', source_name='CASE_TEXT'),
            Column(
                'brand',
            ...
            Column('case_user_response_sla', 'float', source_name='CASE_USER_RESPONSE_SLA'),
            Column('avg_case_user_response_sla', 'float', source_name='AVG_CASE_USER_RESPONSE_SLA'),
            Column('load_time', 'TIMESTAMP_LTZ(7)', delta_column=True),
        ],
        extract_case_id=True,
        look_back_period=14 * 24 * 60 * 60 * 1000,
    ...
    SprinklrConfig(
        ...
        column_list=[
            ...
            Column('case_processing_sla', 'float', source_name='CaseProcessingSLA'),
            Column('avg_case_processing_sla', 'float', source_name='AvgCaseProcessingSLA'),
            Column('load_time', 'TIMESTAMP_LTZ(7)', delta_column=True),
        ],
        extract_case_id=True,
        look_back_period=14 * 24 * 60 * 60 * 1000,
