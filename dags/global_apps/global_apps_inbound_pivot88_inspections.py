...
from include.airflow.operators.pivot88 import Pivot88InspectionsOperator, Pivot88AdvancedDetails
...
from task_configs.dag_config.pivot88 import column_list_inspections, column_list_adv_details
...
with dag:
    ...
    to_s3_inspections >> to_snowflake_inspections >> to_s3_adv_details >> to_snowflake_adv_details
