...
sheets = {
    "oocl": SheetConfig(
        ...
        column_list=[
            ...
            Column("pol_etd", "DATE"),
            Column(
                "oll_billing_invoice_num", "VARCHAR", source_name="OLL Billing Invoice#"
            ),
    ...
    "carmichael": SheetConfig(
        ...
        column_list=[
            Column(
                "broker_ref_num", "VARCHAR", source_name="Broker Ref#", uniqueness=True
            ),
    ...
    "cmt_labor_cost": SheetConfig(
        ...
        column_list=[
            ...
            Column(
                ...
                "NUMBER(38,6)",
                source_name="Unit TS Freight Cost",
            ),
            Column(
                "unit_ts_duty_cost", "NUMBER(38,6)", source_name="Unit TS Duty Cost"
            ),
            Column("unit_ts_cmt", "NUMBER(38,6)", source_name="Unit TS_CMT"),
            Column("unit_ts_tariff", "NUMBER(38,6)", source_name="Unit TS_TARIFF"),
            Column(
                "unit_ts_buyers_comm", "NUMBER(38,6)", source_name="Unit TS_BUYERS_COMM"
            ),
            Column(
                "unit_ts_inspection", "NUMBER(38,6)", source_name="Unit TS_INSPECTION"
            ),
            Column("total_unit_lcm", "NUMBER(38,6)", source_name="TotalUnitLCM"),
            Column(
                "total_ts_freight_cost",
                "NUMBER(38,6)",
                source_name="Total TS Freight Cost",
            ),
            Column(
                "total_ts_duty_cost", "NUMBER(38,6)", source_name="Total TS Duty Cost"
            ),
            ...
            Column(
                ...
                "NUMBER(38,6)",
                source_name="Total TS_BUYERS_COMM",
            ),
            Column(
                "total_ts_inspection", "NUMBER(38,6)", source_name="Total TS_INSPECTION"
            ),
            ...
            Column(
                "landed_cost_absorption", "VARCHAR", source_name="LandedCostAbsorption"
            ),
    ...
    "shipment_data": SheetConfig(
        ...
        column_list=[
            ...
            Column(
                "origin_country_region", "VARCHAR", source_name="Origin Country/Region"
            ),
            ...
            Column(
                "post_advice_number",
                "VARCHAR",
                source_name="Post Advice Number",
                uniqueness=True,
            ),
            ...
            Column(
                "style_color", "VARCHAR", source_name="Style-Color", uniqueness=True
            ),
            ...
            Column(
                ...
                "NUMBER(38,6)",
                source_name="Total Item Volume (CBM)",
            ),
            Column(
                "total_item_weight_kg",
                "NUMBER(38,6)",
                source_name="Total Item Weight (kg)",
            ),
            ...
            Column(
                ...
                "VARCHAR",
                source_name="Vessel/Voyage of All Routes",
            ),
        ],
    ),
    "dhl_invoice": SheetConfig(
        ...
        column_list=[
            Column(
                "billing_account_number", "INT", source_name="Billing Account Number"
            ),
            Column(
                "billing_account_name", "VARCHAR", source_name="Billing Account Name"
            ),
            Column(
                "billing_account_opened_date",
                "DATE",
                source_name="Billing Account Opened Date",
            ),
            Column(
            ...
            Column(
                "billing_account_postal_code",
                "VARCHAR",
                source_name="Billing Account Postal Code",
            ),
            Column(
            ...
            Column(
                "billing_account_mac_code",
                "VARCHAR",
                source_name="Billing Account MAC Code",
            ),
            Column(
                "billing_account_mac_name",
                "VARCHAR",
                source_name="Billing Account MAC Name",
            ),
            Column(
                "billing_account_agc_code",
                "VARCHAR",
                source_name="Billing Account AGC Code",
            ),
            Column(
                "billing_account_agc_name",
                "VARCHAR",
                source_name="Billing Account AGC Name",
            ),
            Column(
                "billing_site_gsfa_id", "VARCHAR", source_name="Billing Site GSFA ID"
            ),
            ...
            Column(
                "billing_parent_gsfa_id",
                "VARCHAR",
                source_name="Billing Parent GSFA ID",
            ),
            ...
            Column(
                "shipper_account_number", "INT", source_name="Shipper Account Number"
            ),
            Column(
                "shipper_account_name", "VARCHAR", source_name="Shipper Account Name"
            ),
            Column("consignor_name", "VARCHAR", source_name="Consignor Name"),
            Column(
                "consignor_contact_name",
                "VARCHAR",
                source_name="Consignor Contact Name",
            ),
            Column(
                "consignor_address_line_1",
                "VARCHAR",
                source_name="Consignor Address Line 1",
            ),
            Column(
                "consignor_address_line_2",
                "VARCHAR",
                source_name="Consignor Address Line 2",
            ),
            Column(
                "consignor_address_line_3",
                "VARCHAR",
                source_name="Consignor Address Line 3",
            ),
            Column("consignor_city_name", "VARCHAR", source_name="Consignor City Name"),
            Column(
                "consignor_state_code", "VARCHAR", source_name="Consignor State Code"
            ),
            Column("consignor_zip_code", "VARCHAR", source_name="Consignor ZIP Code"),
            Column(
                "consignor_country_code",
                "VARCHAR",
                source_name="Consignor Country Code",
            ),
            Column(
                "consignor_country_name",
                "VARCHAR",
                source_name="Consignor Country Name",
            ),
            Column(
                "consignor_telephone_number",
                "VARCHAR",
                source_name="Consignor Telephone Number",
            ),
            Column("consignee_name", "VARCHAR", source_name="Consignee Name"),
            Column(
                "consignee_contact_name",
                "VARCHAR",
                source_name="Consignee Contact Name",
            ),
            Column(
                "consignee_address_line_1",
                "VARCHAR",
                source_name="Consignee Address Line 1",
            ),
            Column(
                "consignee_address_line_2",
                "VARCHAR",
                source_name="Consignee Address Line 2",
            ),
            Column(
                "consignee_address_line_3",
                "VARCHAR",
                source_name="Consignee Address Line 3",
            ),
            Column("consignee_city_name", "VARCHAR", source_name="Consignee City Name"),
            Column(
                "consignee_state_code", "VARCHAR", source_name="Consignee State Code"
            ),
            Column("consignee_zip_code", "VARCHAR", source_name="Consignee ZIP Code"),
            Column(
                "consignee_country_code",
                "VARCHAR",
                source_name="Consignee Country Code",
            ),
            Column(
                "consignee_country_name",
                "VARCHAR",
                source_name="Consignee Country Name",
            ),
            Column(
                "consignee_telephone_number",
                "VARCHAR",
                source_name="Consignee Telephone Number",
            ),
            ...
            Column(
                ...
                "VARCHAR",
                source_name="Origin Service Area Code",
            ),
            Column(
                "origin_service_area_name",
                "VARCHAR",
                source_name="Origin Service Area Name",
            ),
            Column(
                "destination_country_code",
                "VARCHAR",
                source_name="Destination Country Code",
            ),
            Column(
                "destination_country_name",
                "VARCHAR",
                source_name="Destination Country Name",
            ),
            Column(
            ...
            Column(
                "pricing_zone_description",
                "VARCHAR",
                source_name="Pricing Zone Description",
            ),
            ...
            Column(
                "published_revenue_lcy",
                "NUMBER(38,4)",
                source_name="Published Revenue (LCY)",
            ),
            Column(
            ...
            Column(
                "billed_number_of_pieces",
                "NUMBER(38,4)",
                source_name="Billed Number of Pieces",
            ),
            Column(
                "billed_total_revenue_lcy",
                "NUMBER(38,4)",
                source_name="Billed Total Revenue (LCY)",
            ),
            Column(
                "revenue_less_fuel", "NUMBER(38,4)", source_name="Revenue Less Fuel"
            ),
            Column(
                "weight_charge_gross_lcy",
                "NUMBER(38,4)",
                source_name="Weight Charge Gross (LCY)",
            ),
            Column(
            ...
            Column(
                "weight_charge_net_lcy",
                "NUMBER(38,4)",
                source_name="Weight Charge Net (LCY)",
            ),
            Column(
                "total_billed_weight_lbs",
                "NUMBER(38,4)",
                source_name="Total Billed Weight (LBS)",
            ),
            Column(
                "total_billed_weight_kg",
                "NUMBER(38,4)",
                source_name="Total Billed Weight (KG)",
            ),
            Column(
            ...
            Column(
                "surcharge_others_net_lcy",
                "NUMBER(38,4)",
                source_name="Surcharge Others Net (LCY)",
            ),
            Column(
            ...
            Column(
                "surcharge_ras_net_lcy",
                "NUMBER(38,4)",
                source_name="Surcharge RAS Net (LCY)",
            ),
            Column(
            ...
            Column(
                "extra_charge_net_lcy",
                "NUMBER(38,4)",
                source_name="Extra Charge Net (LCY)",
            ),
            Column(
                "insured_value_lcy", "NUMBER(38,4)", source_name="Insured Value (LCY)"
            ),
            Column(
                "tax_discount_lcy", "NUMBER(38,4)", source_name="Tax Discount (LCY)"
            ),
            Column(
                "shipment_tax_lcy", "NUMBER(38,4)", source_name="Shipment Tax (LCY)"
            ),
            Column(
                "tax_others_amount_lcy",
                "NUMBER(38,4)",
                source_name="Tax Others Amount (LCY)",
            ),
            Column(
                "surcharge_duty_net_lcy",
                "NUMBER(38,4)",
                source_name="Surcharge Duty Net (LCY)",
            ),
            Column(
                "surcharge_tax_net_lcy",
                "NUMBER(38,4)",
                source_name="Surcharge Tax Net (LCY)",
            ),
        ],
        dtype={
    ...
    "shipment_data_domestic": SheetConfig(
        ...
        column_list=[
            ...
            Column(
                "origin_container",
                "VARCHAR",
                source_name="Origin Container",
                uniqueness=True,
            ),
            Column(
                "domestic_bl", "VARCHAR", source_name="Domestic BL", uniqueness=True
            ),
...
with dag:
    ...
    for cfg in landed_cost_config:
        ...
        (
            ...
            >> to_s3
            >> to_snowflake
            >> decide_sql_execution
            >> oocl_shipment_to_mssql
        )
