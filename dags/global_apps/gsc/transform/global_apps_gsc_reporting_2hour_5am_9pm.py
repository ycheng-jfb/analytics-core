...
with dag:
    ...
    gsc_lpn_detail_dataset = SnowflakeProcedureOperator(
        procedure='gsc.lpn_detail_dataset.sql', database='reporting_prod', autocommit=False
    )
    gsc_return_detail_dataset = SnowflakeProcedureOperator(
        procedure='gsc.return_detail_dataset.sql', database='reporting_prod', autocommit=False
    )
    gsc_rma_detail_dataset = SnowflakeProcedureOperator(
        procedure='gsc.rma_detail_dataset.sql', database='reporting_prod', autocommit=False
    )
    ...
    gsc_shipment_detail_dataset = SnowflakeProcedureOperator(
        procedure='gsc.shipment_detail_dataset.sql', database='reporting_prod', autocommit=False
    )
    gsc_shipment_dataset = SnowflakeProcedureOperator(
        procedure='gsc.shipment_dataset.sql', database='reporting_prod', autocommit=False
    )
    ...
    gsc_carrier_performance = SnowflakeProcedureOperator(
        procedure='gsc.carrier_performance_dataset.sql', database='reporting_prod', autocommit=False
    )
    gsc_po_audit_trail = SnowflakeProcedureOperator(
        procedure='gsc.po_audit_trail_dataset.sql', database='reporting_prod', autocommit=False
    )
    ...
    check_time_po_skus_data = BranchPythonOperator(task_id="check_time", python_callable=check_time)
