...
uk_sheets = [
    SheetConfig(
        ...
        column_list=[
            ...
            Column(
                name="declaration_type", type="STRING", source_name="Declaration Type"
            ),
            Column(
                name="consignee_reference",
                type="STRING",
                source_name="Consignee Reference",
            ),
            Column(
                name="inventory_reference",
                type="STRING",
                source_name="Inventory Reference",
            ),
            ...
            Column(
                ...
                type="NUMBER(38, 0)",
                source_name="No Packages",
            ),
            Column(
                name="gross_weight", type="NUMBER(38, 10)", source_name="Gross Weight"
            ),
            ...
            Column(
                name="cds_invoice_total",
                type="NUMBER(38, 10)",
                source_name="CDS Invoice Total",
            ),
            Column(
                name="customs_duty_gbp",
                type="NUMBER(38, 10)",
                source_name="Customs Duty GBP",
            ),
            Column(
                name="clearance_cost_eur",
                type="NUMBER(38, 10)",
                source_name="Clearance Cost EUR",
            ),
            Column(
            ...
            Column(
                name="duties_taxes_euro",
                type="NUMBER(38, 10)",
                source_name="Duties & Taxes EURO",
            ),
            Column(
                name="prepayment_euro",
                type="NUMBER(38, 10)",
                source_name="Prepayment EURO",
            ),
            Column(
                name="total_amount_euro",
                type="NUMBER(38, 10)",
                source_name="Total Amount EURO",
            ),
            Column(
                name="customs_vat", type="NUMBER(38, 10)", source_name="Customs VAT"
            ),
            Column(
                name="customs_other_duty",
                type="NUMBER(38, 10)",
                source_name="Customs Other Duty",
            ),
